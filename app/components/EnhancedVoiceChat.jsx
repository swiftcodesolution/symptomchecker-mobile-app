...
const EnhancedVoiceChat = ({ 
  ...
  const sendVoiceMessage = async (message) => {
    try {
      ...
      const success = AIService.sendTextMessage(message)
      
      if (success) {
        setConnectionStatus('AI Responding...')
      } else {
    ...
    <View style={[styles.container, style]}>
      ...
      <View style={styles.audioStatusContainer}>
        <Text style={styles.audioStatusText}>
          Audio Queue: {AIService.getAudioStatus().queueLength}
        </Text>
        <Text style={styles.audioStatusText}>
          Playing: {AIService.getAudioStatus().isPlaying ? 'Yes' : 'No'}
        </Text>
      </View>
    </View>
  )
